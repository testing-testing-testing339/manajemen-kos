          ...
          <table className="w-full min-w-[650px] text-left border-collapse">
            <thead>
              <tr className="bg-slate-900 text-white text-[11px] font-extrabold uppercase tracking-wider">
                <th className="py-3 px-4 whitespace-nowrap">Nama Tabel</th>
                <th className="py-3 px-4 whitespace-nowrap">Kegunaan & Entitas Data</th>
                <th className="py-3 px-4 text-center whitespace-nowrap">Jumlah Baris</th>
                <th className="py-3 px-4 text-center whitespace-nowrap">Estimasi Ukuran</th>
                <th className="py-3 px-4 text-center whitespace-nowrap">Status Health</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 text-xs">
              {tables.map((t) => (
                <tr key={t.name} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="py-3 px-4 text-center font-bold text-slate-900 font-mono whitespace-nowrap">
